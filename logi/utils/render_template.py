...
from logi.utils.custom_dl import TGCustomYield
from logi.utils.file_size import human_size
import urllib.parse
import secrets
import mimetypes
import aiofiles
...
async def render_page(message_id):
    ...
    if mime_type.lower() in video_formats:
        async with aiofiles.open('logi/template/req.html') as r:
        ...
        async with aiofiles.open('logi/template/dl.html') as r:
